<div class="relative overflow-x-auto shadow-md sm:rounded-lg flex-1 p-4">
    <table class="w-full text-sm transition-all ease-in 0.5s text-left text-gray-500 dark:text-gray-400 ">
