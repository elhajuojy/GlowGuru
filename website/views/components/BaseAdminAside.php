<aside class="w-64 h-screen hidden md:block " aria-label="Sidebar">
    <div class="px-3 py-4 overflow-y-auto rounded shadow-orange-50 dark:bg-gray-800">
        ...
        <ul class="space-y-2">
            <li>
                <a href="/admin/dashboard" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
