...
<div class="main-form ">
                <div class="relative z-0 w-full mb-6 group">
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-white">New Product </h3>
                </div>
                <div class="relative z-0   w-full mb-6 group">
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="brand[]" id="brand" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "
                        required />
                ...
                <button class=" btn-remove  py-2.5 text-sm text-white bg-red-600 rounded-md hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-100 dark:focus:ring-offset-gray-800 mb-6 w-48">remove</button>
            </div>
`